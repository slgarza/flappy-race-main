# Flappy Kart Landscape Playable Ad

Landscape HTML5 playable ad for Google Ads App campaigns. The mini-game shows a short race with three rival players, wall collisions, coins, item boxes, a finish line, and strong power-ups revealed from boxes: boost, flomb, and laser.
...
- `flappy-kart-playable-landscape.zip`: upload package with `index.html` at the zip root.
...
```bash
zip -r flappy-kart-playable-landscape.zip index.html assets
```
